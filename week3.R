...
library(sf)
library(here)
st_layers("C:/Users/z1782/OneDrive - University College London/Attachments/005/practical/05 practical/gadm41_AUS.gpkg")

library(sf)
Ausoutline <- st_read("C:/Users/z1782/OneDrive - University College London/Attachments/005/practical/05 practical/gadm41_AUS.gpkg",
                      layer = "ADM_ADM_0")
...
# 使用 terra 包读取压缩后的 .tif 文件
jan <- terra::rast("C:/Users/z1782/OneDrive - University College London/Attachments/005/practical/05 practical/wc2.1_5m_tavg/wc2.1_5m_tavg_01.tif")
...
plot(pr1)
library(fs)
setwd("C:/Users/z1782/OneDrive - University College London/Attachments/005/practical")
dir_info("05 practical/")
setwd("C:/Users/z1782/OneDrive - University College London/Attachments/005/practical/05 practical/")
library(tidyverse)
listfiles <- dir_info("C:/Users/z1782/OneDrive - University College London/Attachments/005/practical/05 practical/wc2.1_5m_tavg/") %>%
